package weddingdressessubscriber;
...
import weddingdressespublisher.WeddingDressesPublisher;

public class WeddingDressesSubscriberActivator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
		...
		serviceReference = context.getServiceReference(WeddingDressesPublisher.class.getName());
		WeddingDressesPublisher weddingDressPublisherService = (WeddingDressesPublisher) context.getService(serviceReference);
...
//				flowerServicePublish.publishService();
				weddingDressPublisherService.WeddingDresses();
				System.out.println("");
