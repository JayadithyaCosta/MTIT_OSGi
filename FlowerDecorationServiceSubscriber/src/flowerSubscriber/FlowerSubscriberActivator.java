...
import flowerPublisher.FlowerServicePublish;

//import flowerPublisher.FlowerServicePublish;

public class FlowerSubscriberActivator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
		...
		serviceReference = context.getServiceReference(FlowerServicePublish.class.getName());
		FlowerServicePublish FlowerServicePublish = (FlowerServicePublish) context.getService(serviceReference);
